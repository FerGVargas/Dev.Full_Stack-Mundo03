...
@NamedQueries({
    ...
    @NamedQuery(name = "Movimento.findByValorUnit", query = "SELECT m FROM Movimento m WHERE m.valorUnit = :valorUnit")})
public class Movimento implements Serializable {
    ...
    public Movimento(Integer idMovimento, int quantidade, Character tipo, BigDecimal valorUnit) {
        this.idMovimento = idMovimento;
